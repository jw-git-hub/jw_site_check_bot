...
# сервер выключен или Мак не в домашней сети: выкладка ходит только по ней) отличается от отказа самой
# команды/проверки, и в обоих случаях сообщение — по-русски, а не сырой вывод git или docker.
remote_or_fail() {
